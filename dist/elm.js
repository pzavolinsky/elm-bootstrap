...
Elm.Bootstrap.Types = Elm.Bootstrap.Types || {};
Elm.Bootstrap.Types.make = function (_elm) {
   "use strict";
   _elm.Bootstrap = _elm.Bootstrap || {};
   _elm.Bootstrap.Types = _elm.Bootstrap.Types || {};
   if (_elm.Bootstrap.Types.values) return _elm.Bootstrap.Types.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   return _elm.Bootstrap.Types.values = {_op: _op};
};
Elm.Bootstrap = Elm.Bootstrap || {};
Elm.Bootstrap.Dropdown = Elm.Bootstrap.Dropdown || {};
Elm.Bootstrap.Dropdown.make = function (_elm) {
   "use strict";
   _elm.Bootstrap = _elm.Bootstrap || {};
   _elm.Bootstrap.Dropdown = _elm.Bootstrap.Dropdown || {};
   if (_elm.Bootstrap.Dropdown.values) return _elm.Bootstrap.Dropdown.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Bootstrap$Types = Elm.Bootstrap.Types.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var menu = F2(function (address,items) {
      var click = function (a) {
         ...
         $Json$Decode.value,
         function (_p0) {
            return A2($Signal.message,address,a);
         });
      };
      var mapItem = function (item) {
         var _p1 = item;
         switch (_p1.ctor)
         {case "ItemHtml": return A2($Html.li,
              _U.list([]),
              _U.list([A2($Html.a,_U.list([A2($Html$Attributes.attribute,"href","#"),click(_p1._0)]),_U.list([_p1._1]))]));
            case "Item": return A2($Html.li,
              _U.list([]),
              _U.list([A2($Html.a,_U.list([A2($Html$Attributes.attribute,"href","#"),click(_p1._0)]),_U.list([$Html.text(_p1._1)]))]));
            case "DisabledHtml": return A2($Html.li,
              _U.list([A2($Html$Attributes.attribute,"class","disabled")]),
              _U.list([A2($Html.a,_U.list([A2($Html$Attributes.attribute,"href","#")]),_U.list([_p1._0]))]));
            case "Disabled": return A2($Html.li,
              _U.list([A2($Html$Attributes.attribute,"class","disabled")]),
              _U.list([A2($Html.a,_U.list([A2($Html$Attributes.attribute,"href","#")]),_U.list([$Html.text(_p1._0)]))]));
            case "HeaderHtml": return A2($Html.li,_U.list([A2($Html$Attributes.attribute,"class","dropdown-header")]),_U.list([_p1._0]));
            case "Header": return A2($Html.li,_U.list([A2($Html$Attributes.attribute,"class","dropdown-header")]),_U.list([$Html.text(_p1._0)]));
            case "Divider": return A2($Html.li,
              _U.list([A2($Html$Attributes.attribute,"role","separator"),A2($Html$Attributes.attribute,"class","divider")]),
              _U.list([]));
            default: return _p1._0;}
      };
      var lis = A2($List.map,mapItem,items);
      return A2($Html.ul,_U.list([A2($Html$Attributes.attribute,"class","dropdown-menu")]),lis);
   });
   var viewWithClass = F6(function (containerClass,wrap,button,children,address,model) {
      var backdrop = model ? _U.list([A2($Html.div,
      _U.list([A2($Html$Attributes.attribute,"class","modal-backdrop fade"),A2($Html$Events.onClick,address,wrap(false))]),
      _U.list([]))]) : _U.list([]);
      var open = model ? " open" : "";
      return A2($Html.div,
      _U.list([A2($Html$Attributes.attribute,"class",A2($Basics._op["++"],containerClass,open))]),
      A2($Basics._op["++"],_U.list([A3(button,wrap,address,model),A2(menu,address,children)]),A2($Basics._op["++"],backdrop,_U.list([]))));
   });
   var viewFor = viewWithClass("dropdown");
   var view = F3(function (button,address,model) {    return A4(viewFor,$Basics.identity,button,address,model);});
   var button = F6(function (f,attrs,children,wrap,address,model) {
      var click = A2($Html$Events.onClick,address,wrap($Basics.not(model)));
      var expanded = model ? _U.list([A2($Html$Attributes.attribute,"aria-expanded","true")]) : _U.list([]);
      return A2(f,A2($Basics._op["++"],attrs,A2($Basics._op["++"],expanded,_U.list([click]))),children);
   });
   var update = F2(function (action,_p2) {    return action;});
   var init = $Basics.identity;
   var Custom = function (a) {    return {ctor: "Custom",_0: a};};
   var Divider = {ctor: "Divider"};
   var Header = function (a) {    return {ctor: "Header",_0: a};};
   var Disabled = function (a) {    return {ctor: "Disabled",_0: a};};
   var Item = F2(function (a,b) {    return {ctor: "Item",_0: a,_1: b};});
   var HeaderHtml = function (a) {    return {ctor: "HeaderHtml",_0: a};};
   var DisabledHtml = function (a) {    return {ctor: "DisabledHtml",_0: a};};
   var ItemHtml = F2(function (a,b) {    return {ctor: "ItemHtml",_0: a,_1: b};});
   return _elm.Bootstrap.Dropdown.values = {_op: _op
                                           ,ItemHtml: ItemHtml
                                           ...
                                           ,menu: menu
                                           ,viewFor: viewFor
                                           ,viewWithClass: viewWithClass};
};
Elm.Bootstrap = Elm.Bootstrap || {};
Elm.Bootstrap.Modal = Elm.Bootstrap.Modal || {};
Elm.Bootstrap.Modal.make = function (_elm) {
   "use strict";
   _elm.Bootstrap = _elm.Bootstrap || {};
   _elm.Bootstrap.Modal = _elm.Bootstrap.Modal || {};
   if (_elm.Bootstrap.Modal.values) return _elm.Bootstrap.Modal.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var view = F5(function (title,body,footer,address,closeAction) {
      var close = A2($Html$Events.onClick,address,closeAction);
      return A2($Html.div,
      _U.list([A2($Html$Attributes.attribute,"class","modal fade in")
              ,A2($Html$Attributes.attribute,"tabindex","-1")
              ,A2($Html$Attributes.attribute,"role","dialog")]),
      _U.list([A2($Html.div,_U.list([A2($Html$Attributes.attribute,"class","modal-backdrop fade in"),close]),_U.list([]))
              ,A2($Html.div,
              _U.list([A2($Html$Attributes.attribute,"class","modal-dialog"),A2($Html$Attributes.attribute,"role","document")]),
              _U.list([A2($Html.div,
              _U.list([A2($Html$Attributes.attribute,"class","modal-content")]),
              _U.list([A2($Html.div,
                      _U.list([A2($Html$Attributes.attribute,"class","modal-header")]),
                      _U.list([A2($Html.button,
                              _U.list([A2($Html$Attributes.attribute,"type","button")
                                      ,A2($Html$Attributes.attribute,"class","close")
                                      ,A2($Html$Attributes.attribute,"aria-label","Close")
                                      ,close]),
                              _U.list([A2($Html.span,_U.list([A2($Html$Attributes.attribute,"aria-hidden","true")]),_U.list([$Html.text("×")]))]))
                              ,A2($Html.h4,_U.list([A2($Html$Attributes.attribute,"class","modal-title")]),_U.list([title]))]))
                      ,A2($Html.div,_U.list([A2($Html$Attributes.attribute,"class","modal-body")]),_U.list([body]))
                      ,A2($Html.div,_U.list([A2($Html$Attributes.attribute,"class","modal-footer")]),_U.list([footer]))]))]))]));
   });
   var title = $Html.text;
   return _elm.Bootstrap.Modal.values = {_op: _op,title: title,view: view};
};
Elm.Bootstrap = Elm.Bootstrap || {};
Elm.Bootstrap.Select = Elm.Bootstrap.Select || {};
Elm.Bootstrap.Select.make = function (_elm) {
   "use strict";
   _elm.Bootstrap = _elm.Bootstrap || {};
   _elm.Bootstrap.Select = _elm.Bootstrap.Select || {};
   if (_elm.Bootstrap.Select.values) return _elm.Bootstrap.Select.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Bootstrap$Dropdown = Elm.Bootstrap.Dropdown.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Attributes = Elm.Html.Attributes.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var update = F2(function (action,model) {
      var _p0 = action;
      if (_p0.ctor === "Select") {
            return _U.update(model,{value: _p0._0,open: false});
         } else {
            return _U.update(model,{open: _p0._0});
         }
   });
   var Toggle = function (a) {    return {ctor: "Toggle",_0: a};};
   var Select = function (a) {    return {ctor: "Select",_0: a};};
   var view$ = F5(function (renderValue,renderItem,$class,address,model) {
      var mapOption = function (o) {    return A2($Bootstrap$Dropdown.ItemHtml,Select(o),renderItem(o));};
      var items = A2($List.map,mapOption,model.options);
      var button = A3($Bootstrap$Dropdown.button,
      $Html.button,
      _U.list([A2($Html$Attributes.attribute,"class",$class),A2($Html$Attributes.attribute,"type","button")]),
      _U.list([renderValue(model.value),$Html.text(" "),A2($Html.span,_U.list([A2($Html$Attributes.attribute,"class","caret")]),_U.list([]))]));
      return A5($Bootstrap$Dropdown.viewFor,Toggle,button,items,address,model.open);
   });
   var view = function (render) {    return A2(view$,render,render);};
   var set = F2(function (value,model) {    return _U.update(model,{value: value});});
   var value = function (model) {    return model.value;};
   var init = F2(function (options,value) {    return {value: value,options: options,open: false};});
   var Model = F3(function (a,b,c) {    return {value: a,options: b,open: c};});
   return _elm.Bootstrap.Select.values = {_op: _op
                                         ,Model: Model
                                         ,init: init
                                         ,value: value
                                         ,set: set
...
Elm.Test = Elm.Test || {};
Elm.Test.Dropdown = Elm.Test.Dropdown || {};
Elm.Test.Dropdown.make = function (_elm) {
   "use strict";
   _elm.Test = _elm.Test || {};
   _elm.Test.Dropdown = _elm.Test.Dropdown || {};
   if (_elm.Test.Dropdown.values) return _elm.Test.Dropdown.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Bootstrap$Dropdown = Elm.Bootstrap.Dropdown.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   var update = F2(function (action,model) {
      var _p0 = action;
      if (_p0.ctor === "Click") {
            var _p1 = A2($Debug.log,"click",_p0._0);
            return _U.update(model,{showDropdown: false});
         } else {
            return _U.update(model,{showDropdown: _p0._0});
         }
   });
   var Click = function (a) {    return {ctor: "Click",_0: a};};
   var Dropdown = function (a) {    return {ctor: "Dropdown",_0: a};};
   var dropdownView = F2(function (address,showDropdown) {
      var items = _U.list([$Bootstrap$Dropdown.Header("Actions")
                          ,A2($Bootstrap$Dropdown.Item,Click("a1"),"Action 1")
                          ,$Bootstrap$Dropdown.Divider
                          ,A2($Bootstrap$Dropdown.Item,Click("a2"),"Action 2")]);
      var button = A3($Bootstrap$Dropdown.button,
      $Html.button,
      _U.list([A2($Html$Attributes.attribute,"class","btn btn-primary"),A2($Html$Attributes.attribute,"type","button")]),
      _U.list([$Html.text("\n        Dropdown "),A2($Html.span,_U.list([A2($Html$Attributes.attribute,"class","caret")]),_U.list([]))]));
      return A5($Bootstrap$Dropdown.viewFor,Dropdown,button,items,address,showDropdown);
   });
   var view = F2(function (address,model) {
      return A2($Html.div,_U.list([]),_U.list([A2(dropdownView,address,model.showDropdown),$Html.text(" (check the browser console)\n  ")]));
   });
   var init = {showDropdown: false};
   var main = $StartApp$Simple.start({model: init,update: update,view: view});
   var Model = function (a) {    return {showDropdown: a};};
   return _elm.Test.Dropdown.values = {_op: _op
                                      ,Model: Model
                                      ,init: init
                                      ,Dropdown: Dropdown
                                      ,Click: Click
...
Elm.Test = Elm.Test || {};
Elm.Test.Modal = Elm.Test.Modal || {};
Elm.Test.Modal.make = function (_elm) {
   "use strict";
   _elm.Test = _elm.Test || {};
   _elm.Test.Modal = _elm.Test.Modal || {};
   if (_elm.Test.Modal.values) return _elm.Test.Modal.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Bootstrap$Modal = Elm.Bootstrap.Modal.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Attributes = Elm.Html.Attributes.make(_elm),
   $Html$Events = Elm.Html.Events.make(_elm),
   ...
   var update = F2(function (action,model) {
      var _p0 = action;
      if (_p0.ctor === "OpenModal") {
            return _U.update(model,{showModal: true});
         } else {
            return _U.update(model,{showModal: false});
         }
   });
   var CloseModal = {ctor: "CloseModal"};
   var modalView = function (address) {
      var footer = A2($Html.div,
      _U.list([]),
      _U.list([A2($Html.button,
              _U.list([A2($Html$Attributes.attribute,"type","button")
                      ,A2($Html$Attributes.attribute,"class","btn btn-default")
                      ,A2($Html$Events.onClick,address,CloseModal)]),
              _U.list([$Html.text("Yes")]))
              ,A2($Html.button,
              _U.list([A2($Html$Attributes.attribute,"type","button")
                      ,A2($Html$Attributes.attribute,"class","btn btn-primary")
                      ,A2($Html$Events.onClick,address,CloseModal)]),
              _U.list([$Html.text("Sure!")]))]));
      var body = A2($Html.p,_U.list([]),_U.list([$Html.text("Should we close this modal?")]));
      var title = $Bootstrap$Modal.title("Question:");
      return A5($Bootstrap$Modal.view,title,body,footer,address,CloseModal);
   };
   var OpenModal = {ctor: "OpenModal"};
   var view = F2(function (address,model) {
      var click = A2($Html$Events.onClick,address,OpenModal);
      var modal = model.showModal ? _U.list([modalView(address)]) : _U.list([]);
      return A2($Html.div,
      _U.list([]),
      A2($Basics._op["++"],
      _U.list([]),
      ...
      modal,
      _U.list([A2($Html.button,
      _U.list([A2($Html$Attributes.attribute,"type","button"),A2($Html$Attributes.attribute,"class","btn btn-success"),click]),
      _U.list([$Html.text("Open modal!")]))]))));
   });
   var init = {showModal: false};
   var main = $StartApp$Simple.start({model: init,update: update,view: view});
   var Model = function (a) {    return {showModal: a};};
   return _elm.Test.Modal.values = {_op: _op
                                   ,Model: Model
                                   ,init: init
                                   ,OpenModal: OpenModal
...
Elm.Test = Elm.Test || {};
Elm.Test.Select = Elm.Test.Select || {};
Elm.Test.Select.make = function (_elm) {
   "use strict";
   _elm.Test = _elm.Test || {};
   _elm.Test.Select = _elm.Test.Select || {};
   if (_elm.Test.Select.values) return _elm.Test.Select.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Bootstrap$Select = Elm.Bootstrap.Select.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Attributes = Elm.Html.Attributes.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var update = F2(function (action,model) {    var _p1 = action;return _U.update(model,{color: A2($Bootstrap$Select.update,_p1._0,model.color)});});
   var Select = function (a) {    return {ctor: "Select",_0: a};};
   var selectView = F2(function (address,model) {
      var renderItem = function (c) {
         return A2($Html.span,
         _U.list([A2($Html$Attributes.attribute,"class",A2($Basics._op["++"],"text-",colorClass(c)))]),
         _U.list([$Html.text($Basics.toString(c))]));
      };
      var renderValue = function (_p2) {    return $Html.text($Basics.toString(_p2));};
      var color = $Bootstrap$Select.value(model);
      var $class = colorClass(color);
      return A5($Bootstrap$Select.view$,renderValue,renderItem,A2($Basics._op["++"],"btn btn-",$class),A2($Signal.forwardTo,address,Select),model);
   });
   var view = F2(function (address,model) {    return A2($Html.div,_U.list([]),_U.list([A2(selectView,address,model.color)]));});
   var Model = function (a) {    return {color: a};};
   var Blue = {ctor: "Blue"};
   var Green = {ctor: "Green"};
   var Red = {ctor: "Red"};
   var init = {color: A2($Bootstrap$Select.init,_U.list([Red,Green,Blue]),Green)};
   var main = $StartApp$Simple.start({model: init,update: update,view: view});
   return _elm.Test.Select.values = {_op: _op
                                    ,Red: Red
                                    ,Green: Green
                                    ,Blue: Blue
                                    ,Model: Model
...
Elm.Test = Elm.Test || {};
Elm.Test.Example = Elm.Test.Example || {};
Elm.Test.Example.make = function (_elm) {
   "use strict";
   _elm.Test = _elm.Test || {};
   _elm.Test.Example = _elm.Test.Example || {};
   if (_elm.Test.Example.values) return _elm.Test.Example.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Bootstrap$Dropdown = Elm.Bootstrap.Dropdown.make(_elm),
   $Bootstrap$Modal = Elm.Bootstrap.Modal.make(_elm),
   ...
   var update = F2(function (action,model) {
      var _p0 = action;
      switch (_p0.ctor)
      {case "Click": var _p1 = A2($Debug.log,"click",_p0._0);
           return _U.update(model,{showDropdown: false});
         case "Dropdown": return _U.update(model,{showDropdown: _p0._0});
         case "OpenModal": return _U.update(model,{showModal: true,showDropdown: false});
         case "SaveModal": return _U.update(model,{showModal: false,simpson: A2($Bootstrap$Select.set,"Maggie",model.simpson)});
         case "CloseModal": return _U.update(model,{showModal: false});
         default: return _U.update(model,{simpson: A2($Bootstrap$Select.update,_p0._0,model.simpson)});}
   });
   var Select = function (a) {    return {ctor: "Select",_0: a};};
   var selectView = function (address) {    return A3($Bootstrap$Select.view,$Html.text,"btn btn-default",A2($Signal.forwardTo,address,Select));};
   var CloseModal = {ctor: "CloseModal"};
   var SaveModal = {ctor: "SaveModal"};
   var modalView = function (address) {
      var footer = A2($Html.div,
      _U.list([]),
      _U.list([A2($Html.button,
              _U.list([A2($Html$Attributes.attribute,"type","button")
                      ,A2($Html$Attributes.attribute,"class","btn btn-default")
                      ,A2($Html$Events.onClick,address,CloseModal)]),
              _U.list([$Html.text("Nop")]))
              ,A2($Html.button,
              _U.list([A2($Html$Attributes.attribute,"type","button")
                      ,A2($Html$Attributes.attribute,"class","btn btn-primary")
                      ,A2($Html$Events.onClick,address,SaveModal)]),
              _U.list([$Html.text("Sure!")]))]));
      var body = A2($Html.p,_U.list([]),_U.list([$Html.text("Should we set that thing to \"Maggie\"")]));
      var title = $Bootstrap$Modal.title("Choose Maggie");
      return A5($Bootstrap$Modal.view,title,body,footer,address,CloseModal);
   };
   var OpenModal = {ctor: "OpenModal"};
   var Click = function (a) {    return {ctor: "Click",_0: a};};
   ...
   var dropdownView = F2(function (address,showDropdown) {
      var items = _U.list([$Bootstrap$Dropdown.Header("Actions")
                          ...
                          ,A2($Bootstrap$Dropdown.Item,Click("a2"),"Action 2")
                          ,$Bootstrap$Dropdown.Divider
                          ,A2($Bootstrap$Dropdown.Item,OpenModal,"Show modal")]);
      var button = A3($Bootstrap$Dropdown.button,
      $Html.button,
      _U.list([A2($Html$Attributes.attribute,"class","btn btn-primary"),A2($Html$Attributes.attribute,"type","button")]),
      _U.list([$Html.text("\n        Dropdown "),A2($Html.span,_U.list([A2($Html$Attributes.attribute,"class","caret")]),_U.list([]))]));
   ...
   var view = F2(function (address,model) {
      ...
      return A2($Html.div,
      _U.list([]),
      A2($Basics._op["++"],_U.list([A2(dropdownView,address,model.showDropdown)]),A2($Basics._op["++"],modal,_U.list([A2(selectView,address,model.simpson)]))));
   });
   var init = {showDropdown: false,showModal: false,simpson: A2($Bootstrap$Select.init,_U.list(["Homer","Marge","Bart","Lisa","Maggie"]),"Bart")};
   var main = $StartApp$Simple.start({model: init,update: update,view: view});
   var Model = F3(function (a,b,c) {    return {showDropdown: a,showModal: b,simpson: c};});
   return _elm.Test.Example.values = {_op: _op
                                     ,Model: Model
                                     ,init: init
                                     ,Dropdown: Dropdown
                                     ,Click: Click
...
Elm.Main.make = function (_elm) {
   ...
   var _op = {};
   var unused = "Not used";
   return _elm.Main.values = {_op: _op,unused: unused};
};
